    ...
    try {
        ...
        if(resultado == 1){
            ...
            if(email != null && !email.isEmpty()) {
                EmailSender.sendEmail(email, "Inicio de sesión exitoso", "Has iniciado sesión exitosamente en el sistema.");
            }
...
private String obtenerEmailUsuario(String usuario) throws SQLException {
    String email = "";
    String query = "SELECT email FROM tabla_usuarios WHERE username = ?";
    PreparedStatement ps = cc.openConnection().prepareStatement(query);
